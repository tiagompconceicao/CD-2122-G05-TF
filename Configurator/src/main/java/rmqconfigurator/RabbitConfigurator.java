...
public class RabbitConfigurator {
    ...
    private static int Menu() {
        ...
        do {
            ...
            System.out.println(" 2 - Bind Queue to Exchange");
            System.out.println(" 3 - Bind Exchange to Exchange");
            System.out.println(" 4 - Bind Queue to Exchange with Headers");
    ...
    static BuiltinExchangeType readEXchangeType() {
        ...
        do {
            System.out.println();
            System.out.println("    TIPO DE EXCHANGE");
